// Consts
const apikey = "bba68fc16e827af8baf1e6dd556b8b2a";
...
const apiPaths = {
    ...
    searchOnYoutube: (query) => `https://www.googleapis.com/youtube/v3/search?part=snippet&q=${query}&key=AIzaSyB_8sWbQVpeQC_-2aE4fBu3VokvSxRvtyo`
}
